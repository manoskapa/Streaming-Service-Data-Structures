...
/**
* Struct ure defining a node of movie binary tree (dendro tainiwn kathgorias)ss
*/
 ...
 */
 ...
 int watch_movie(unsigned int userID,unsigned int category, unsigned int movieID, int score);
 ...
 */
 ...
 int inorderQcounter(userMovie_t *tmp);
 int inorderQscore(userMovie_t *tmp);
